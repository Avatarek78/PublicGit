var XWiki = (function (XWiki) {
  ...
  var init = function() {
    /*
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              */
    var sources = [{"name":"Document names","varname":"input","script":"/get/XWiki/SuggestSolrService?query=type%3ADOCUMENT+AND+%28title%3A%28__INPUT__%2A%29+OR+name%3A%28__INPUT__%2A%29+OR+name_exact%3A%28__INPUT__%2A%29%29&nb=3&outputSyntax=plain","icon":"/resources/icons/silk/page_white_text.png","highlight":true},{"name":"Document content","varname":"input","script":"/get/XWiki/SuggestSolrService?query=type%3ADOCUMENT+AND+%28doccontent%3A%28__INPUT__%2A%29+OR+doccontentraw%3A%28__INPUT__%2A%29%29&nb=3&outputSyntax=plain","icon":"/resources/icons/silk/page_white_text.png","highlight":false},{"name":"Attachment names","varname":"input","script":"/get/XWiki/SuggestSolrService?query=type%3AATTACHMENT+AND+filename%3A%28__INPUT__%2A%29&nb=3&outputSyntax=plain","icon":"/resources/icons/silk/attach.png","highlight":true},{"name":"Attachment content","varname":"input","script":"/get/XWiki/SuggestSolrService?query=type%3AATTACHMENT+AND+attcontent%3A%28__INPUT__%2A%29&nb=3&outputSyntax=plain","icon":"/resources/icons/silk/attach.png","highlight":false},{"name":"Users","varname":"input","script":"/get/XWiki/SuggestSolrService?query=type%3AOBJECT+AND+class%3AXWiki.XWikiUsers+AND+objcontent%3A%28__INPUT__%2A%29&nb=3&outputSyntax=plain","icon":"/resources/icons/silk/user.png","highlight":false},{"name":"Wikis","varname":"input","script":"/get/WikiManager/WikisSuggestSolrService?query=class%3AXWiki.XWikiServerClass+AND+propertyname%3Awikiprettyname+AND+propertyvalue__%3A%28__INPUT__%2A%29&nb=3&outputSyntax=plain","icon":"/resources/icons/silk/chart_organisation.png","highlight":true}];
