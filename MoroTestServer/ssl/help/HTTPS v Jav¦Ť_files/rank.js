...
function rateIt(me, article, thread)
{
	if(!rated){
		document.getElementById("rateStatus").innerHTML = document.getElementById("ratingSaved").innerHTML+me.title;
		preSet = me;
		rated=1;
        window.location="/rank/" + article + "/" + thread + "/" + a;
		rating(me);
	}
}
...
$(function(){
	$("#ratingDetail").click(function(){
		...
		else
		{
			...
			$.post('/api/Articles-Article/rating/' + articleName, {}, function(res){
