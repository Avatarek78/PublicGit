 ...
 * @author Tomas
 */
public class MessageCommObjForServer implements Serializable{    
     ...
     * @param strMessage 
     */
    public MessageCommObjForServer(String strMessage) { 
    ...
    /**
     * Formated string representation of the sent date. 
